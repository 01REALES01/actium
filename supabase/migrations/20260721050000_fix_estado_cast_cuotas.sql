-- =============================================================================
-- ACTIUM | Fix — re-aplica cast ::factura_estado en las RPC recreadas
-- =============================================================================
-- Al recrear registrar_pago_cxp, registrar_cobro_cuota_cxc y crear
-- registrar_pago_cuota_cxp se omitió el cast explícito de la expresión CASE al
-- enum factura_estado, reintroduciendo el error 42804
-- ("column estado is of type factura_estado but expression is of type text").
-- Aquí se corrigen las tres, conservando el gate auth_puede_finanzas.
-- =============================================================================

-- registrar_pago_cxp (pago de factura completa CxP)
...
BEGIN
  ...
  FROM public.cuentas_por_pagar WHERE id = p_cxp_id;
...
-- registrar_cobro_cuota_cxc (cobro de cuota CxC)
...
-- registrar_pago_cuota_cxp (pago de cuota CxP)
