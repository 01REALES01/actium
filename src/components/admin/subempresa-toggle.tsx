...
import { toggleSubempresaActivaAction } from "@/lib/actions/admin";

export function SubempresaToggle({
  subempresaId,
  activa,
}: {
  subempresaId: string;
  ...
  function onToggle() {
    ...
    startTransition(async () => {
      try {
        await toggleSubempresaActivaAction({ subempresaId, activa: siguiente });
      } catch (e) {
